...
if options.calc_vert_profiles
    ...
    if options.calc_ebal
        ...
        fidhl           = fopen([Output_dir,'layer_H.dat'],'a'); %%JM edit replaced layer_h.dat
        fprintf(fidhl,'%9.2f',[profiles.Hc1d' fluxes.Hstot]);
        fprintf(fidhl,'\r');
        
        fidlel          = fopen([Output_dir,'layer_lE.dat'],'a'); %% JM edit replace layer_le.dat
        fprintf(fidlel,'%9.2f',[profiles.lEc1d' fluxes.lEstot]);
        fprintf(fidlel,'\r');
        
        fidal           = fopen([Output_dir,'layer_A.dat'],'a'); %% JM edit replaced layer_a.dat
        ...
        fidrn           = fopen([Output_dir,'layer_Rn.dat'],'a'); %% JM edit replaced layer_rn.dat
