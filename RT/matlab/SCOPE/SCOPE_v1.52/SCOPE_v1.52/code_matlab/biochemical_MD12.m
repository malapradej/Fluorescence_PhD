...
kf        = 6.7E7;                                    % [s-1]         rate constant for fluorescence
kD        = 6.03E8;                                   % [s-1]         rate constant for thermal deactivation at Fm
kd        = 1.0e9;                                    % [s-1]         rate constant of energy dissipation in closed RCs (for theta=0.7 under un-stressed conditions)  
