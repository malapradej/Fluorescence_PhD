...
2;		%Fluorescence_model		0: empirical, with sustained NPQ (fit to Flexas' data); 1: empirical, with sigmoid for Kn; 2: Magnani 2012 model
0;      %Fluspect_version       0: version 2010 (bug fixed in 2014); 1: version 2014
